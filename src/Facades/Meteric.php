 ...
 * @method static \Meteric\Subscriptions\OrderBuilder createOrder(?\Illuminate\Database\Eloquent\Model $customer = null)
 * @method static \Meteric\Models\Order payOrder(\Meteric\Models\Order $order, Money $amount, ?string $ref = null)
