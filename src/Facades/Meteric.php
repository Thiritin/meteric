 ...
 * @method static \Meteric\Models\Subscription cancel(\Meteric\Models\Subscription $sub, string|\Carbon\CarbonImmutable $at = 'period_end', ?\Carbon\CarbonImmutable $when = null)
